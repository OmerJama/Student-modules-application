    ...
    public void initialize() {
        ...
        studentListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Student>() {
            ...
            public void changed(ObservableValue<? extends Student> observable, Student oldValue, Student newValue) {
                ...
                */
                Student newStudent = studentListView.getSelectionModel().getSelectedItem();
                yearStudyView.setText(newStudent.getYearOfStudy());
                mod1View.setText(newStudent.getModule1());
                mod2View.setText(newStudent.getModule2());
                mod3View.setText(newStudent.getModule3());
            }
        });
    ...
    public void editStudent(Student stu) {
        ...
        try {
            ...
            /* TODO: print an appropriate message if it cannot be loaded
                     print stacktrace
             */
            System.out.println("Could not load new dialog");
